...
- שמות בעברית מדוברת ישראלית בלבד — אותיות עבריות בלבד, אסור בשום פנים להשתמש בתווים מכל שפה אחרת.`,
    ...
    const nameMsg = await anthropic.messages.create({
      ...
      max_tokens: 60,
      temperature: 0.3,
      system: 'תאר את המנה כמו שישראלי אומר בפה — עברית מדוברת, עד 10 מילים. דוגמאות למילים נכונות: מלפפון, שעועית ירוקה, עוף, בשר, פירה, אורז, סלט. פלט תיאור בלבד, ללא "בצלחת יש".',
      messages: [{
        role: 'user',
        content: [

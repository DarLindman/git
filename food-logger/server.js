...
שלב 1 — זיהוי: זהה כל מרכיב גלוי בתמונה.
...
כללים:
- תאר תמיד לפי המרכיבים הספציפיים: "פילה דג עם פירה וסלט", "כבדי עוף עם בצל מטוגן", "פסטה עם שמנת ונקניק"
- רק אם המרכיבים תואמים בדיוק למנה מפורסמת — אפשר להשתמש בשמה: שניצל = בשר מצופה פירורי לחם, קרבונרה = פסטה+ביצים+גואנצ'לה (ללא שמנת), וולינגטון = בקר+בצק עלים+פטריות
- ספק ספיקא — תאר בעברית, אל תנחש שם מפורסם
- אסור: "ארוחת X", "מנת X עשירה", שמות ז'אנריים
- פלט שם בלבד, עברית בלבד`,
